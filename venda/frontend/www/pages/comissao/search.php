	...
	<form role="form">
		<div class="box-body">
			...
			<div class="col-sm-2" style="width: 130px;">
				<label>Data</label>
				<input ng-model="pedido.data1" id="data1" class="form-control date" style="width:100px" />
			</div>
			...
			<div class="col-sm-2" style="width: 130px;">
				<label style="color:#fff">-</label>
				<input ng-model="pedido.data2" id="data2" class="form-control date" style="width:100px" />
			</div>
